...
import * as XLSX from "xlsx"; // Import for Excel export functionality
...
const TargetReport = ({ reports }) => {
    ...
    useEffect(() => {
        // Group reports by user and calculate total daily sales and control numbers
        const aggregatedData = reports.data.reduce((acc, report) => {
            ...
            // Sum up the daily sales and control number amounts
            acc[userId].totalDailySales += report.daily_sales
            ...
            // Store sales data by date for this user
